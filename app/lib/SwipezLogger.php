...
/**
 * This is a base class for all object types within PGYBT application.
 * This call instantiates the log object and other bootstrapping objects required for PGYBT application.
 *
 * @author Shuhaid
 */
class SwipezLogger {
