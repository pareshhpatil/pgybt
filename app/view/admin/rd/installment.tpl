...
<div class="page-content">
    <!-- BEGIN PAGE HEADER-->
    <h3 class="page-title">RD Installment</h3>
    <!-- END PAGE HEADER-->
    <!-- BEGIN PAGE CONTENT-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    ...
                    <form action="/admin/rd/installmentsave" method="post" id="submit_form" class="form-horizontal form-row-sepe">
                        <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label class="control-label col-md-6">RD Policy <span class="required">
                                                    </span></label>
                                                <div class="col-md-6">
                                                    <select name="rd_id" required onchange="getplandetails('rd', this.value);" class="form-control select2me" data-placeholder="Select...">
                                                        <option value=""></option>
                                                        {foreach from=$rdList item=v}
                                                            <option value="{$v.rd_id}">{$v.name}</option>
                                                        {/foreach}
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <input type="number" min="0" step="0.01" required="" id="installment" name="amount" class="form-control" >
                                                    </div>	
                                                </div> 
                                            </div>
                                            <div class="form-group">
