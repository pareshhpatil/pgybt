                            ...
                            <form action="" method="">
                                {foreach from=$loan_list item=v}
                                    <tr>
                                        ...
                                        <td class="td-c">
                                            <a href="/admin/fd/certificate/{$v.paylink}" title="Certificate" class="btn btn-xs blue"><i class="fa fa-tasks"></i> Certificate</a>
                                            <a href="/admin/receipt/view/{$v.receipt_id}" title="Receipt" class="btn btn-xs blue"><i class="fa fa-tasks"></i> Receipt</a>
                                        </td>
                                    </tr>
