        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    ...
                    <form action="/admin/subuser/roleupdatesaved" method="post" id="submit_form" class="form-horizontal form-row-sepe">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" required name="role_name" class="form-control" value="{$details.name}">
                                        </div>
                                    </div>
                                                    ...
                                                    {foreach from=$list item=v}
                                                        <tr>
                                                            ...
                                                            <td class="td-c">
                                                                ...
                                                                {else}
                                                                    <input  {$v.checked} name="controllers[]" value="{$v.controller_id}" type="checkbox">
                                                                {/if}
