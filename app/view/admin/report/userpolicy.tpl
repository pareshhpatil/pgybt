        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="portlet-body" >
                        ...
                        <form class="form-inline" role="form" action="" method="post">
                            <div class="form-group">
                                <select class="form-control select2me" style="width: 450px;" name="user_id" data-placeholder="Select User">
                                    <option value=""></option>

                                    {foreach from=$user_list item=v}
                                        {if $user_selected==$v.user_id}
                                            <option selected value="{$v.user_id}">{$v.name}</option>
                                        {else}
                ...
                <div class="portlet box blue-hoki">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-globe"></i>View User Policy
                        </div>
                        <div class="tools">
                        </div>
                    </div>
