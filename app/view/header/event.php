...
<html lang="en">
    ...
    <head>
        ...
        <script src="/assets/admin/layout/scripts/template.js" type="text/javascript"></script>
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content" style="font-size: 14px; line-height: 2">
            ...
            <div class="page-container">
                ...
                <?php } else { ?>
                    ...
                    <body class="page-header-fixed page-quick-sidebar-over-content"  style="font-size: 14px; line-height: 2;min-width: 620px;">
