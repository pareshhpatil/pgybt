...
function repeatChange(value)
{
    ...
    if (value == '1')
    {
        ...
        document.getElementById('repeat_on').disabled = true;

    }
    if (value == '2')
    {
        document.getElementById('repeat_text').innerHTML = 'weeks';
        document.getElementById('repeat_on').disabled = false;
        setStartdate();
    }
    if (value == '3')
    {
...
function setStartdate()
{
    ...
    var billdate = Date();
    if (mode == 2) {
        var weekday = document.getElementById('repeat_on').value;
...
function diplayText()
{
    ...
    var skillsSelect = document.getElementById("repeat_on");
